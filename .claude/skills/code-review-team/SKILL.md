...
async function codeReviewTeam(prNumber: number) {
  ...
  const taskSpecs = [
    {
      ...
      name: "정적 분석",
      output: "_workspace/review/01_static.md",
    },
    {
      agent: "design-reviewer",
      name: "설계 검토",
      output: "_workspace/review/02_design.md",
    },
    {
      agent: "security-auditor",
      name: "보안 감사",
      output: "_workspace/review/03_security.md",
    },
    {
      agent: "refactorer",
      name: "리팩토링",
      output: "_workspace/review/04_refactor.md",
  ...
  // ──────────────────────────────────────────────
  await waitForTeamCompletion(team.id, {
    tasks: ["정적 분석", "설계 검토", "보안 감사"],
  });
